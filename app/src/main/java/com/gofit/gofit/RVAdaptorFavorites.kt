...
class RVAdaptorFavorites(private val items: List<WorkoutActivity.Item>, private val numberWorkouts: Int, private val workoutList: ArrayList<Workout>) : RecyclerView.Adapter<RVAdaptorFavorites.ViewHolder>() {
